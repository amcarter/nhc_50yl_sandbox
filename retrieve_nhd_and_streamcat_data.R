#NHC watershed summary data ~1970-present
...
#pardon the superfluous code. this was adapted from another script.
sites = select(sites, -FROMMEAS, -TOMEAS, -AREASQKM, -AREASQKM_corr,
               -TOTDASQKM, -MINELEVSMO, -MAXELEVSMO)
